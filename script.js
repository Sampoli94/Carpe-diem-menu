...
const CAFE = { 
  ...
  qrTargetUrl: "https://carpediemmenu.vercel.app/#menu", 
}; 
...
const MENU = [ 
  { 
    ...
    items: [ 
      ...
      { name: { it: "Cappuccino Senza Lattosio", en: "Lactose-Free Cappuccino" }, price: "€ 2,20" }, 
  ...
  { 
    ...
    items: [ 
      ...
      { name: { it: "Latte Di Mandorla", en: "Almond Milk" }, price: "€ 2,50" },
      { name: { it: "Granita / Granita Con Panna", en: "Granita / Granita With Cream" }, price: "€ 2,50 / € 3,00" }, 
      { name: { it: "Schweppes (Limone/Tonica)", en: "Schweppes (Lemon/Tonic)" }, price: "€ 2,00" },
      { name: { it: "Estathe Brick (Pesca/Limone)", en: "Estathe Brick (Peach/Lemon)" }, price: "€ 1,00" },
      { name: { it: "Estathe Lattina (Pesca/Limone)", en: "Estathe Can (Peach/Lemon)" }, price: "€ 2,00" }, 
      { name: { it: "Estathe Vetro (Pesca/Limone)", en: "Estathe Glass (Peach/Lemon)" }, price: "€ 2,20" },
      { name: { it: "Estathe 400ml (Pesca/Limone)", en: "Estathe 400ml (Peach/Lemon)" }, price: "€ 2,20" },
      { name: { it: "Estathe Deteinato (Pesca/Limone)", en: "Estathe Decaf (Peach/Lemon)" }, price: "€ 1,50" },
...
function setupMenuDropdown() { 
  ...
  // Event listener per aprire/chiudere (solo una volta)
  if (!dropdownInitialized && dropdownBtn) {
